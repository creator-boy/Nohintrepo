...
def stats(update, context):
    if ospath.exists('.git'):
        ...
        last_commit = 'No UPSTREAM_COMMIT_TILL_NOW'
...
'''
        ...
        sendMarkup('Not Authorized user, Idk Don't play with bot', context.bot, update.message, reply_markup)
